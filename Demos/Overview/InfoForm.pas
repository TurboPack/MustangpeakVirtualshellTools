...
begin
  ...
  CheckBox39.Checked := Assigned(NS.ShellFolder);
  ...
  if Assigned(NS.ShellLink) then
    CheckBox28.Checked := Assigned(NS.ShellLink.ShellLinkAInterface)
  else
    CheckBox28.Checked := False;
  CheckBox26.Checked := Assigned(NS.ExtractImage.ExtractImageInterface);
  CheckBox27.Checked := Assigned(NS.ExtractImage.ExtractImage2Interface);
  CheckBox1.Checked := Assigned(NS.ShellIconInterface);
  CheckBox40.Checked := Assigned(NS.ShellIconOverlayInterface);
  ...
  // IShellIconOverlay
  Label10.Caption := 'Overlay Index = ' + IntToStr(NS.OverlayIndex);
  Label15.Caption := 'Overlay Icon Index = ' + IntToStr(NS.OverlayIconIndex);
