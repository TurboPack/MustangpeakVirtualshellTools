...
// (DO NOT EDIT: machine generated header) 'VirtualCommandLine.pas' rev: 30.00 (Windows)
...
protected:
	__property NativeUInt hPipe1Write = {read=FhPipe1Write, write=FhPipe1Write, nodefault};
	__property NativeUInt hPipe1ReadDuplicate = {read=FhPipe1ReadDuplicate, write=FhPipe1ReadDuplicate, nodefault};
	__property NativeUInt hPipe2Read = {read=FhPipe2Read, write=FhPipe2Read, nodefault};
	__property NativeUInt hPipe2WriteDuplicate = {read=FhPipe2WriteDuplicate, write=FhPipe2WriteDuplicate, nodefault};
