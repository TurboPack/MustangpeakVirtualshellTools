...
// (DO NOT EDIT: machine generated header) 'VirtualRedirector.pas' rev: 31.00 (Windows)
...
protected:
	...
	__property NativeUInt PipeIn = {read=FPipeIn, write=FPipeIn, nodefault};
	__property NativeUInt PipeErrorIn = {read=FPipeErrorIn, write=FPipeErrorIn, nodefault};
...
protected:
	virtual void __fastcall Execute(void);
	__property NativeUInt ChildProcess = {read=FChildProcess, write=FChildProcess, nodefault};
public:
...
protected:
	...
	__property HWND HelperWnd = {read=FHelperWnd, write=FHelperWnd, nodefault};
	...
	__property NativeUInt PipeOut = {read=FPipeOut, write=FPipeOut, nodefault};
	__property NativeUInt PipeIn = {read=FPipeIn, write=FPipeIn, nodefault};
	__property NativeUInt PipeErrorIn = {read=FPipeErrorIn, write=FPipeErrorIn, nodefault};
...
public:
	...
	__property NativeUInt ChildProcessHandle = {read=GetChildProcessHandle, nodefault};
	__property unsigned ChildProcessID = {read=GetChildProcessID, nodefault};
	__property NativeUInt ChildProcessThread = {read=GetChildProcessThread, nodefault};
