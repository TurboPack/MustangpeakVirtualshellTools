...
// (DO NOT EDIT: machine generated header) 'VirtualShellNotifier.pas' rev: 30.00 (Windows)
...
public:
	...
	__property NativeUInt WorkerChangeEvent = {read=FWorkerChangeEvent, write=FWorkerChangeEvent, nodefault};
...
private:
	...
	__property NativeUInt ChangeNotifyHandle = {read=FChangeNotifyHandle, write=FChangeNotifyHandle, nodefault};
	__property HWND NotifyWindowHandle = {read=FNotifyWindowHandle, write=FNotifyWindowHandle, nodefault};
...
public:
	...
	HIDESBASE void __fastcall TriggerEvent(void);
	__property TVirtualChangeNotifier* ChangeNotifier = {read=FChangeNotifier};
	__property NativeUInt KernelChangeEvent = {read=FKernelChangeEvent, write=FKernelChangeEvent, nodefault};
};
...
protected:
	...
	__property HWND Listener = {read=FListener, write=FListener, nodefault};
