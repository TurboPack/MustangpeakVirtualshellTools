...
protected:
	...
	virtual HRESULT __fastcall DragOverOLE(int grfKeyState, const System::Types::TPoint &pt, int &dwEffect);
	...
	__property NativeUInt ThemeToolbar = {read=GetThemeToolbar, nodefault};
	__property NativeUInt Timer = {read=FTimer, nodefault};
...
protected:
	...
	virtual bool __fastcall CanAutoSize(int &NewWidth, int &NewHeight);
	System::Types::TRect __fastcall ClosestButtonEdge(const System::Types::TPoint &ScreenPoint);
	...
	virtual HRESULT __stdcall DragEnter(const _di_IDataObject dataObj, int grfKeyState, const System::Types::TPoint pt, int &dwEffect);
	virtual HRESULT __stdcall DragOverOLE(int grfKeyState, const System::Types::TPoint pt, int &dwEffect);
	virtual HRESULT __stdcall DragLeave(void);
	void __fastcall DrawDropMarker(System::Types::PPoint MousePos, bool ForceDraw);
	virtual HRESULT __stdcall Drop(const _di_IDataObject dataObj, int grfKeyState, const System::Types::TPoint pt, int &dwEffect);
	...
	TCustomWideSpeedButton* __fastcall PointToButton(const System::Types::TPoint &ScreenPt);
	int __fastcall PointToInsertIndex(const System::Types::TPoint &ScreenPt);
	virtual HRESULT __stdcall QueryContinueDrag(System::LongBool fEscapePressed, int grfKeyState);
	...
	void __fastcall UpdateDropStates(const System::Types::TPoint &ScreenMousePos);
	...
	__property NativeUInt HotTrackTimer = {read=FHotTrackTimer, write=FHotTrackTimer, nodefault};
