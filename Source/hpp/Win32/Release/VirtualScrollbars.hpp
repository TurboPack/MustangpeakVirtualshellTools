...
// (DO NOT EDIT: machine generated header) 'VirtualScrollbars.pas' rev: 30.00 (Windows)
...
protected:
	...
	void __fastcall HandleHotTracking(const System::Types::TPoint &MousePos, bool ForceClearAll);
	...
	void __fastcall ScrollClick(const System::Types::TPoint &Pos);
	...
	__property NativeUInt TimerAutoScroll = {read=FTimerAutoScroll, write=FTimerAutoScroll, nodefault};
	__property NativeUInt TimerAutoScrollDelay = {read=FTimerAutoScrollDelay, write=FTimerAutoScrollDelay, nodefault};
	__property NativeUInt TimerHot = {read=FTimerHot, write=FTimerHot, nodefault};
