...
_DECLARE_METACLASS(System::TMetaClass, TUserDataStorageClass);
...
_DECLARE_METACLASS(System::TMetaClass, TVETColumnClass);
...
public:
	...
	bool __fastcall ShowContextMenuOfActiveNode(System::Types::TPoint Point);
...
typedef void __fastcall (__closure *TVETOnTreeDblClick)(TCustomVirtualExplorerTree* Sender, Virtualtrees::PVirtualNode Node, System::Uitypes::TMouseButton Button, System::Types::TPoint Point);
...
protected:
	...
	virtual int __fastcall ShowBkGndContextMenu(System::Types::TPoint Point);
	...
	virtual Vcl::Menus::TPopupMenu* __fastcall DoGetPopupMenu(Virtualtrees::PVirtualNode Node, Virtualtrees::TColumnIndex Column, System::Types::TPoint Position);
	...
	virtual void __fastcall DoPopupMenu(Virtualtrees::PVirtualNode Node, Virtualtrees::TColumnIndex Column, System::Types::TPoint Position);
	...
	virtual void __fastcall DoTreeDblClick(System::Uitypes::TMouseButton Button, System::Types::TPoint Position);
	virtual void __fastcall DoUpdating(Virtualtrees::TVTUpdateState State);
	virtual HRESULT __fastcall DragDrop(const _di_IDataObject DataObject, int KeyState, System::Types::TPoint Pt, int &Effect);
	...
	virtual HRESULT __fastcall DragOver(System::TObject* Source, int KeyState, System::Uitypes::TDragState DragState, System::Types::TPoint Pt, int &Effect);
	void __fastcall DummyOnDragOver(Virtualtrees::TBaseVirtualTree* Sender, System::TObject* Source, System::Classes::TShiftState Shift, System::Uitypes::TDragState State, System::Types::TPoint Pt, Virtualtrees::TDropMode Mode, int &Effect, bool &Accept);
	...
	__property NativeUInt EnumTimer = {read=FEnumTimer, write=FEnumTimer};
	...
	__property NativeUInt ShellNotifyTimerHandle = {read=FShellNotifyTimerHandle, write=FShellNotifyTimerHandle};
...
protected:
	...
	virtual bool __fastcall AllowClickInWindow(HWND Window, System::Types::TPoint Point);
...
protected:
	...
	__property NativeUInt ThemeButton = {read=FThemeButton, write=FThemeButton};
	__property NativeUInt ThemeCombo = {read=FThemeCombo, write=FThemeCombo};
	__property NativeUInt ThemeEdit = {read=FThemeEdit, write=FThemeEdit};
	__property bool ThemesActive = {read=FThemesActive, write=FThemesActive, nodefault};
...
protected:
	...
	__property NativeUInt WndHandle = {read=FWndHandle, write=FWndHandle};
...
static const unsigned __int64 TID_ICON = 0x0000000000002706ULL;
static const unsigned __int64 TID_EXPANDMARK = 0x0000000000002707ULL;
