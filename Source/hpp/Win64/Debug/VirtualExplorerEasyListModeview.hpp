...
// (DO NOT EDIT: machine generated header) 'VirtualExplorerEasyListModeview.pas' rev: 30.00 (Windows)
...
_DECLARE_METACLASS(System::TMetaClass, TListModeEasyListviewClass);
...
typedef void __fastcall (__closure *TListviewContextMenuEvent)(TCustomVirtualColumnModeView* Sender, Easylistview::TCustomEasyListview* Listview, System::Types::TPoint MousePt, bool &Handled);
...
typedef void __fastcall (__closure *TListviewDblClickEvent)(TCustomVirtualColumnModeView* Sender, Easylistview::TCustomEasyListview* Listview, Mpcommonutilities::TCommonMouseButton Button, System::Types::TPoint MousePos, System::Classes::TShiftState ShiftState);
...
public:
	TColumnModeEasyListview* operator[](int Index) { return Views[Index]; }
...
protected:
	...
	virtual void __fastcall DoListviewContextMenu(Easylistview::TCustomEasyListview* Sender, System::Types::TPoint MousePt, bool &Handled);
	...
	virtual void __fastcall DoListviewDbkClick(Easylistview::TCustomEasyListview* Sender, Mpcommonutilities::TCommonMouseButton Button, System::Types::TPoint MousePos, System::Classes::TShiftState ShiftState, bool &Handled);
	...
	void __fastcall ListviewContextMenu(Easylistview::TCustomEasyListview* Sender, System::Types::TPoint MousePt, bool &Handled);
	...
	void __fastcall ListviewDblClick(Easylistview::TCustomEasyListview* Sender, Mpcommonutilities::TCommonMouseButton Button, System::Types::TPoint MousePos, System::Classes::TShiftState ShiftState, bool &Handled);
