...
// (DO NOT EDIT: machine generated header) 'VirtualExplorerEasyListview.pas' rev: 32.00 (Windows)
...
_DECLARE_METACLASS(System::TMetaClass, TExplorerItemClass);
...
_DECLARE_METACLASS(System::TMetaClass, TExplorerColumnClass);
...
_DECLARE_METACLASS(System::TMetaClass, TExplorerGroupClass);
...
protected:
	...
	virtual void __fastcall DoColumnContextMenu(const Easylistview::TEasyHitInfoColumn &HitInfo, System::Types::TPoint WindowPoint, Vcl::Menus::TPopupMenu* &Menu);
	...
	virtual void __fastcall DoHintPopup(Easylistview::TEasyCollectionItem* TargetObj, Easylistview::TEasyHintType HintType, System::Types::TPoint MousePos, System::WideString &AText, int &HideTimeout, int &ReshowTimeout, bool &Allow);
	void __fastcall DoInvalidRootNamespace(void);
	virtual void __fastcall DoItemContextMenu(const Easylistview::TEasyHitInfoItem &HitInfo, System::Types::TPoint WindowPoint, Vcl::Menus::TPopupMenu* &Menu, bool &Handled);
	...
	virtual void __fastcall DoItemDblClick(Mpcommonutilities::TCommonMouseButton Button, System::Types::TPoint MousePos, const Easylistview::TEasyHitInfoItem &HitInfo);
	...
	void __fastcall Enqueue(Mpshellutilities::TNamespace* NS, Easylistview::TEasyItem* Item, System::Types::TPoint ThumbSize, bool UseShellExtraction, bool IsResizing);
	...
	__property HWND ClipChainWnd = {read=FClipChainWnd, write=FClipChainWnd};
...
//-- var, const, procedure ---------------------------------------------------
static const unsigned __int64 TID_ICON = 0x0000000000000064ULL;
static const unsigned __int64 TID_THUMBNAIL = 1ULL;
static const unsigned __int64 TID_DETAILS = 2ULL;
static const unsigned __int64 TID_DETAILSOF = 3ULL;
...
extern DELPHI_PACKAGE void __fastcall AddThumbRequest(Vcl::Controls::TWinControl* Window, TExplorerItem* Item, System::Types::TPoint ThumbSize, bool UseExifThumbnail, bool UseExifOrientation, bool UseShellExtraction, bool UseSubsampling, bool IsResizing, TThumbThreadCreateProc ThumbRequestClassCallback);
