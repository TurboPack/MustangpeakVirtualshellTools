...
// (DO NOT EDIT: machine generated header) 'ColumnForm.pas' rev: 32.00 (Windows)
...
__published:
	...
	void __fastcall VSTColumnNamesDragOver(Virtualtrees::TBaseVirtualTree* Sender, System::TObject* Source, System::Classes::TShiftState Shift, System::Uitypes::TDragState State, System::Types::TPoint Pt, Virtualtrees::TDropMode Mode, int &Effect, bool &Accept);
	...
	void __fastcall VSTColumnNamesDragDrop(Virtualtrees::TBaseVirtualTree* Sender, System::TObject* Source, _di_IDataObject DataObject, Virtualtrees::TFormatArray Formats, System::Classes::TShiftState Shift, System::Types::TPoint Pt, int &Effect, Virtualtrees::TDropMode Mode);
