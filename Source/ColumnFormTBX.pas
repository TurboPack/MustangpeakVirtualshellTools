...
uses
  ...
  StdCtrls, ExtCtrls, VirtualTrees, ActiveX, TBXDkPanels,
  TntForms;
...
type
  TFormColumnSettings = class(TTntForm)
    Bevel1: TBevel;
    Label2: TTBXLabel;
    Label3: TTBXLabel;
    Panel1: TPanel;
    Label1: TTBXLabel;
    CheckBoxLiveUpdate: TTBXCheckBox;
    ButtonOk: TTBXButton;
    ButtonCancel: TTBXButton;
    VSTColumnNames: TVirtualStringTree;
    EditPixelWidth: TEdit;
    procedure VSTColumnNamesGetText(
